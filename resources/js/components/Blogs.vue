                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr v-for="blog in blogs.data" :key="blog.id">
                      ...
                      <td>
                        <img class="img-fluid mb-3" :src="'./images/blogs/'+blog.photo" style="width:70px;" alt=" Avatar">
                      </td>
                      <td>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" v-show="!editmode" id="blogModalLabel">Add Blog Details</h5>
                        <h5 class="modal-title" v-show="editmode" id="blogModalLabel">Update Blog Info</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input v-model="form.heading" type="text" name="heading" placeholder="Blog heading"
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group row">
                            <label for="photo" class="col-sm-4 col-form-label">Blog Photo</label>
                            <div class="col-sm-6">
                                <input type="file" v-show="!editmode" accept="image/*" @change="uploadphoto" class="form-input"/>
                                <input type="file" v-show="editmode" accept="image/*" @change="updateBlogPic"  class="form-input"/>
                            </div>
                        </div>
                    </div>
            ...
            deleteBlog(id){
                Swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.value) {
                            this.form.delete('api/blogs/'+id).then(()=>{
                                    Swal.fire(
                                    'Deleted!',
