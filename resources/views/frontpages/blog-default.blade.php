            ...
            <div class="row">
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            <div class="post-holder">
                                ...
                                <div class="post-content">
                                    ...
                                    <div class="post-header">
                                        <!-- post header -->
                                        <h1 class="post-title"><a href="blog-single.html" class="title">Heading title of Dental treatment Blog post</a></h1>
                                        <div class="meta"> <span class="meta-date"> 26 june, 2020</span> <span class="meta-comments">(20) Comments</span> </div>
                                    </div>
                                    <!-- /.post header -->
                                    <p>Eleifend felis tortor quis diam praesent feugiat in metus tempor faucibus maecenas eget consectetur curabitur hendrerit fringilla enim accumsan turpis aliquam fringilla nulla hendrerit le posuere vel ex at vulputate.Praesent volutpat consequat urna lorem. </p>
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            <div class="post-holder">
                                ...
                                <div class="post-content">
                                    ...
                                    <div class="post-header">
                                        <!-- post header -->
                                        <h1 class="post-title"><a href="blog-single.html" class="title">What are the alternatives to dental implants?</a></h1>
                                        <div class="meta"> <span class="meta-date"> 25 june, 2020</span> <span class="meta-comments">(21) Comments</span> </div>
                                    </div>
                                    <!-- /.post header -->
                                    <p>Consectetur et interdum et vulputate mauris vestibulum ullamcorper sapien eget sodales feugiat etiam ut justo ut sem molestie viverra massa pellentesque non tellus urna donec dolor orci nulla et erat consequat porta tellus.lorem ipsum dolot sit non.</p>
                                    <a href="#" class="btn btn-primary">Read More</a> </div>
                                <!-- /.post content -->
                            </div>
                            <!-- /.post holder -->
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            <div class="post-holder">
                                ...
                                <div class="post-content">
                                    ...
                                    <div class="post-header">
                                        <!-- post header -->
                                        <h1 class="post-title"><a href="blog-single.html" class="title">Suffering from a Teeth Problem</a></h1>
                                        <div class="meta"> <span class="meta-date"> 23 june, 2020</span> <span class="meta-comments">(24) Comments</span> </div>
                                    </div>
                                    <!-- /.post header -->
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <ul>
                            <li>
                                <div class="recent-post">
                                    ...
                                    <h4 class="recent-title "><a href="#" class="title">What are the alternatives to dental implants?</a></h4>
                            ...
                            <li>
                                <div class="recent-post">
                                    <div class="recent-img">
                                        ...
                                        <h4 class="recent-title"><a href="#" class="title">Heading title of Dental treatment Blog post</a></h4>
                                    </div>
                                </div>
                                <div class="meta">
                                    <span class="meta-date">27 june, 2020</span> </div>
                        </ul>
                    </div>
                    ...
                    <div class=" widget widget-tags ">
                        ...
                        <a href="#">dentist</a><a href="#">dental</a><a href="#">root canal</a><a href="#">Cosmetic </a><a href="#">teeth</a><a href="#">Dentistry</a></div>
                    <!-- widget-Tag close -->
                </div>
            </div>
        </div>
